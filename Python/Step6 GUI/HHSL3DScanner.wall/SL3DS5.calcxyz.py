...
for ii in range(0,m-1):
    if (maskleft[ii] and maskright[ii]):
        ...
        if ((np.linalg.norm(abdist)<50) and (xyzdata[2]>300 and xyzdata[2]<2000 and xyzdata[0]>-500 and xyzdata[0]<500)):
           xyz[kk,0]= -xyzdata[0]
           xyz[kk,1]= -xyzdata[1]
           xyz[kk,2]= -xyzdata[2]
...
# Create a PLY file to save the XYZ and colors of point cloud
